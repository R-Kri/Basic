...
addTwo(5)// It will give error cause we cannot precall it in this (2nd type) of declaration. Declaaration se pehle hum use nahi kr skte when we declare the function with second method.
